...
- **Telemetry Metrics:** Calculated 5-hour rolling window usage, cooldown countdown timers (second-by-second countdown to slot release), and past 7-day weekly activity histograms per agent (Claude Pro, Gemini Default, Auth, Marmut).
...
- **Documentation:** Updated `docs/USER_MANUAL.md` and `README.md` detailing the T3 Code zero-API-key architecture and configuration instructions for new homelab deployments (`T3_DATA_DIR`, Docker volume mounts).
