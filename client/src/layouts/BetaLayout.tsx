    ...
    <div className="relative flex min-h-screen flex-col bg-cockpit-bg text-cockpit-text transition-colors duration-250 font-sans">
      ...
      <div className="mx-auto flex w-full max-w-[1600px] flex-1 items-start gap-4">
        ...
        <main className="w-full min-w-0 flex-1 space-y-8 p-4 sm:p-6 lg:p-8 mt-2">
          ...
          <div className="border-4 border-yellow-500 bg-yellow-500/10 p-4 shadow-[4px_4px_0_rgba(234,179,8,1)] flex items-start gap-3 mb-6">
            <span className="bg-yellow-500 text-black px-1.5 py-0.5 text-xs font-black uppercase tracking-widest leading-none mt-0.5">WARNING</span>
            <p className="font-mono text-xs uppercase tracking-widest text-cockpit-text">
              Beta UI Active. This view restructures the same core application components heavily. Content features remain functionally unaltered.
            </p>
          </div>
