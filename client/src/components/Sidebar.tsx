...
export const Sidebar: React.FC = () => {
  ...
  return (
    <aside
      className={`sticky top-4 z-30 my-4 ml-4 hidden h-[calc(100vh-2rem)] shrink-0 flex-col rounded-panel border border-cockpit-border bg-cockpit-panel shadow-lg shadow-black/10 transition-all duration-200 md:flex ${
